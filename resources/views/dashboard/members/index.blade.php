...
<div class="pt-6 px-12">
    ...
    <div class="flex gap-8">
        ...
        <div class="card w-1/5 rounded-3xl py-12 border border-4 border-neutral-800 hover:border-sky-600 bg-neutral-800 opacity-[60%] hover:opacity-100 cursor-pointer shadow-[5px_5px_20px_rgba(14,165,233,0.3)]">
