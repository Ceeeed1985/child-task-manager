...
@section('title', "Ajouter une sanction")

@section('content')
<div class="pt-6 px-12">
    <h1 class="text-sky-600 text-3xl font-bold mb-12">Ajouter une nouvelle sanction</h1>
    <div class="flex gap-8 w-1/4">
        <form action="{{ route('sanctions.store') }}" method="post" class="w-full" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex flex-col gap-1 mb-4">
                <div class="flex flex-col gap-1">
                    <label for="points" class="text-white text-lg w-full">Indiquez ici les points perdus</label>
            ...
            <button type="submit" class="bg-sky-600 hover:bg-sky-800 text-white px-4 py-2 rounded">Ajouter une sanction</button>
        </form>
    </div>
