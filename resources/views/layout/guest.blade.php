    ...
    <nav class="bg-sky-900 p-4 flex justify-between space-x-4">
        <div class="flex justify-between space-x-4">
            <ul class="flex items-center gap-4">
                <li><a href="{{ route('home') }}" class="text-gray-200 hover:text-white">Accueil</a></li>
        ...
        <a href="{{ route('login') }}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="size-8">
