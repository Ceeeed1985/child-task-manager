...
<body class="bg-neutral-900 flex">
    <aside class="flex flex-col w-1/6 h-screen px-4 py-8 overflow-y-auto bg-neutral-900 border-r-2 border-neutral-800">
        <a href="#" class="text-xl text-white flex gap-2 ">
            ...
            <span class="text-sky-700 font-bold">Manager</span>
        </a>
        <!-- A voir si on ajoute => hover:drop-shadow-[0_0_5px_rgba(56,189,248,0.4)]-->
        <div class="flex flex-col justify-between flex-1 mt-12">
            <nav>
                <a class="flex items-center mx-2 px-4 pt-2 pb-2 text-neutral-300 hover:text-white border-b-2 border-neutral-900 hover:border-b-2 hover:border-sky-800 focus:text-white focus:border-b-2 focus:border-sky-800" href="{{ route('dashboard') }}">
                ...
                <a class="flex items-center mx-2 px-4 pt-2 mt-4 pb-2 text-neutral-300 hover:text-white border-b-2 border-neutral-900 hover:border-b-2 hover:border-sky-800 focus:text-white focus:border-b-2 focus:border-sky-800" href="{{ route('members.index') }}">
                    ...
                    <span class="mx-4 font-medium">Famille</span>
                </a>

                <a href="{{ route('tasks.index') }}" class="flex items-center mx-2 px-4 pt-2 mt-4 pb-2 text-neutral-300 hover:text-white border-b-2 border-neutral-900 hover:border-b-2 hover:border-sky-800 focus:text-white focus:border-b-2 focus:border-sky-800">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <a class="flex items-center mx-2 px-4 pt-2 mt-4 pb-2 text-neutral-300 hover:text-white border-b-2 border-neutral-900 hover:border-b-2 hover:border-sky-800 focus:text-white focus:border-b-2 focus:border-sky-800" href="#">
                    ...
                    <span class="mx-4 font-medium">Sanctions</span>
                </a>
                ...
                <a class="flex items-center mx-2 px-4 pt-2 mt-4 pb-2 text-neutral-300 hover:text-white border-b-2 border-neutral-900 hover:border-b-2 hover:border-sky-800 focus:text-white focus:border-b-2 focus:border-sky-800" href="#">
                    ...
                    <span class="mx-4 font-medium">Récompenses</span>
                </a>
                ...
                <hr class="my-6 mx-6 border-neutral-800 border-1" />
