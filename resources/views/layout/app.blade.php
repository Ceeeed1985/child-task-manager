...
<body class="bg-neutral-900 flex">
    <aside class="flex flex-col w-72 h-screen px-4 py-8 overflow-y-auto bg-neutral-900 border-r-2 border-neutral-800">
        ...
        <div class="flex flex-col justify-between flex-1 mt-12">
            <nav>
                <a class="flex items-center mx-2 px-4 pt-2 pb-4 text-neutral-400 hover:text-neutral-200 focus:text-neutral-200" href="{{ route('dashboard') }}">
                ...
                <a class="flex items-center mx-2 px-4 pt-2 pb-4 text-neutral-400 hover:text-neutral-200 focus:text-neutral-200" href="#">
            ...
            <a href="#" class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-15 w-15" src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80" alt="avatar" />
                <span class="mx-2 font-medium text-neutral-400 text-lg">John Doe</span>
            </a>
        </div>
        ...
        <form class="mt-8 text-right" action="{{ route('logout') }}" method="post">
            @csrf
            <button type="submit" class="py-2 px-4 bg-orange-500 hover:bg-orange-700 text-white rounded-md flex items-center justify-self-end gap-2 group overflow-hidden relative">
