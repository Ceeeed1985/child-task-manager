...
<body class="bg-neutral-900 flex">
    <aside class="flex flex-col w-72 h-screen px-4 py-8 overflow-y-auto bg-neutral-900 border-r-2 border-neutral-800">
        ...
        <div class="flex flex-col justify-between flex-1 mt-12">
            <nav>
                <a class="flex items-center mx-2 px-4 pt-2 pb-2 text-neutral-300 hover:text-white hover:border-b-2 hover:border-sky-800 focus:text-white focus:border-b-2 focus:border-sky-800" href="{{ route('dashboard') }}">
                ...
                <a class="flex items-center mx-2 px-4 pt-2 mt-4 pb-2 text-neutral-300 hover:text-white hover:border-b-2 hover:border-sky-800 focus:text-white focus:border-b-2 focus:border-sky-800" href="#">
