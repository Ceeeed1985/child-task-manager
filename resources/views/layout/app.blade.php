...
<body class="bg-white flex">
    <aside class="flex flex-col w-72 h-screen px-4 py-8 overflow-y-auto bg-sky-100">
        <a href="#" class="text-2xl text-sky-800 text-center">Child Task <span class="text-orange-600 font-semibold">Manager</span></a>
